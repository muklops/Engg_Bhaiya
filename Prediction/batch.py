...
class batch_prediction:
    def __init__(self,input_file_path,
                 ...
                 feature_engerineering_file_path)-> None:
        self.input_file_path = input_file_path
        self.model_file_path = model_file_path
        self.transformer_file_path = transformer_file_path
        self.feature_engerineering_file_path = feature_engerineering_file_path

    def start_batch_prediction(self):
        try:
            #load the feature engg pipeline
            with open(self.feature_engerineering_file_path,'rb') as f:
                feature_pipeline = pickle.load(f)

            #load data transformation pipleline path
            ...
            #crete feature engg pipeline
            feature_engneering_pipeline = Pipeline([
            ...
            df.to_csv('df_Zomato_delivery_time_pred.csv')

            #Apply Feature Engineering pipeline steps:
            df = feature_engneering_pipeline.transform(df)
